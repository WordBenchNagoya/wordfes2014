...
class Camptix_Widgets extends WP_Widget {
  ...
  ?>
	<div class="participate-contents">
		<?php
		$unsold_seat = $camptix->get_remaining_tickets( '370' , true );
		$all_seat = get_post_meta( '370', 'tix_quantity', true );
		 ?>
		...
		<?php
		$unsold_seat = $camptix->get_remaining_tickets( '371' , true );
		$all_seat = get_post_meta( '371', 'tix_quantity', true );
		 ?>
		...
		<?php
		$unsold_seat = $camptix->get_remaining_tickets( '372' , true );
		$all_seat = get_post_meta( '372', 'tix_quantity', true );
		 ?>
