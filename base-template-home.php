...
<body <?php body_class( 'home' ) ?> onload="init();">
		...
		<div class="container">
			<div class="social-area">
				...
				<div class="sns-button">
					<a href="https://twitter.com/share" data-url="http://2014.wordfes.org" class="twitter-share-button" data-via="wordbenchnagoya" data-lang="">ツイートする</a>
				</div>
			</div>
		...
		<div class="container">
			<div class="clearfix">
				<div class="col-md-6 main_logo">
					...
					<p>WordFesとして2年目を迎える今年は、
					「愛がある、冒険がある、WordPressがある」をテーマにしました。
					WordPressやコミニティを通じての出逢いや経験に感謝のキモチと愛をこめて、
					そして、このWordFesで新しい発見や気付きが生まれて冒険したくなるような、
					ワクワクするイベントになればと思います。</p>
				</div>
				<div class="col-md-6 hidden-xs" id="livestage">
					<div class="slider">
						<img src="data:image/png;base64,">
					</div>
	...
	<section id="schedule">
		<div class="container">
			<div class="clearfix">
				<h2>SCHEDULE</h2>
				<section class="col-md-4" id="conference">
					<h3><i class="glyphicon glyphicon-pencil"></i><span>CONFERENCE</span>セッション</h3>
					<div class="inner">
						<p class="text-center time"><strong>8.30</strong>(SAT)<em>11:00-17:00</em></p>
						<table class="table table-bordered">
							<tr>
								<th>場所</th>
								<td>名古屋工業大学 52号館　<a href="http://maps.google.com/maps?q=35.158406,136.924918" target="_blank" class="linkicon">MAP</a></td>
							</tr>
							<tr>
								<th>料金</th>
								<td>0円（無料）</td>
				...
				<section class="col-md-4" id="party">
					<h3><i class="glyphicon glyphicon-cutlery"></i><span>PARTY</span>セッション + 懇親会</h3>
					<div class="inner">
						<p class="text-center time"><strong>8.30</strong>(SAT)<em>17:30-19:30</em></p>
						<table class="table table-bordered">
							<tr>
								<th>場所</th>
								<td>浩養園〈こうようえん〉　<a href="http://maps.google.com/maps?q=浩養園" target="_blank" class="linkicon">MAP</a></td>
							</tr>
							<tr>
								<th>料金</th>
								<td>4,000円</td>
						...
						<!--p class="text-center"><a href="<?php echo esc_url( site_url( '/entry/' ) ) ?>" class="btn btn-primary">詳細&アクセスを見る</a></p-->
					</div>
				</section>
				<section class="col-md-4" id="stay">
					<h3><i class="glyphicon glyphicon-briefcase"></i><span>STAY &amp; MEETING</span>セッション + 懇親会 + 宿泊</h3>
					<div class="inner">
						<p class="text-center time"><strong>8.30</strong>(SAT)<em>19:30 - </em><strong>8.31</strong>(SUN)</p>
						<table class="table table-bordered">
							<tr>
								<th>場所</th>
								<td>新舞子まなビレッジ南浜荘　<a href="http://maps.google.com/maps?q=新舞子まなビレッジ南浜荘" target="_blank" class="linkicon">MAP</a></td>
							</tr>
							<tr>
								<th>料金</th>
								<td>8,000円（懇親会費含む）</td>
		...
		<div class="container">
			...
			<div class="clearfix section--contents">
				<div class="col-xs-6 col-lg-3 col-md-4">
					<a href="<?php echo site_url( '/sponsor/' ) ?>"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/banner/sponsor_bn.png" alt="スポンサー様募集中"></a>
				</div>
				<!--div class="col-xs-6 col-lg-3 col-md-4">
					<a href="<?php echo site_url( '/attention/' ) ?>"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/banner/attention_bn.png" alt="ご来場の方へご注意とお願い"></a>
				</div-->
				<!--div class="col-xs-6 col-lg-3 col-md-4">
					<a href="<?php echo site_url( '/staff/' ) ?>"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/banner/staff_bn.png" alt="スタッフ紹介"></a>
				</div-->
				<!--div class="col-xs-6 col-lg-3 col-md-4">
					<a href="<?php echo site_url( '/banner-gallery/' ) ?>"><img src="http://2014.wordfes.org/wp-content/uploads/2014/07/gallery_bn.png" alt="バナーギャラリー"></a>
				</div-->
				<div class="col-xs-6 col-lg-3 col-md-4"></div>
			</div>
		</div>
	</section><!--/pickup area -->
